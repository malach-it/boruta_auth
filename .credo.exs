  ...
  configs: [
    %{
      ...
      checks: [
        ...
        # TODO comments track the implementation backlog and are not lint
        # findings.
        ...
        # This check supports Elixir versions before 1.8 only.
        ...
        # This check supports Elixir versions before 1.7 only.
