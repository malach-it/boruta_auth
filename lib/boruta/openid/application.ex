defmodule Boruta.Openid.Application do
  ...
  > __Note__: This behaviour is splitted into `Boruta.Openid.JwksApplication` providing utilities to implement the different OpenID Connect endpoints independently.
  """
